...
public class ObjectCreationMode : MonoBehaviour, IInteractionManagerMode
{
    ...
    public void SetSpawnedObjectType(int spawnedObjectType)
    {
        ...
        {
            case 0:
                _currentMaterial = _colorController.model[0].material;
                break;
            case 1:
                _currentMaterial = _colorController.model[1].material;
                break;
            case 2:
                _currentMaterial = _colorController.model[2].material;
                break;
        }
